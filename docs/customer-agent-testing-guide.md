...
### ✅ Cách 2: Real LLM (Cần NVIDIA NIM API key)

```bash
# Set API key (lấy từ: https://build.nvidia.com/)
...
- [ ] Real LLM test passes (if API key set)
- [ ] API endpoint returns 200 (after implementation)
